...
app1.controller('doorctrlr', ['$scope', '$http', '$location', function($scope, $http, $location) {
  ...
  $scope.knocknock = function() {
    if (!$scope.openBooking) {
      ...
      var Baseurl = 'https://agent.electricimp.com/aWbnQBCsu2K8/valbooking';
  ...
  $scope.submitbooking = function() {
    ...
    $http ({
       method   : 'POST',
       url      : 'https://agent.electricimp.com/aWbnQBCsu2K8/confirmbooking',
  ...
  $scope.unlockDoor = function() {
    ...
    $http ({
       method   : 'POST',
       url      : 'https://agent.electricimp.com/aWbnQBCsu2K8/unlockrequest',
       headers : {'Content-Type' : 'application/x-www-form-urlencoded'},
  ...
  function pollFunc() {
    ...
    var canPoll = true;
    if ($scope.pollDoor) {
      var Baseurl = 'https://agent.electricimp.com/aWbnQBCsu2K8/chkbutton';
      if (typeof(Storage) !== 'undefined') {
  ...
  function pollDoorOpen(doorToken) {
    var gINTERVAL = 2000;
    var canPoll = true;
    var Baseurl = 'https://agent.electricimp.com/aWbnQBCsu2K8/chkthedoor';
    var startTime = (new Date()).getTime();
